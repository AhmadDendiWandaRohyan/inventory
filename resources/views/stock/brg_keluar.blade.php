...
<head>
    ...
    <title>Ali Inventory | Barang Keluar</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="active">
                                    ...
                                    <li class="active"><a href="/stock/brg_keluar">Barang Keluar</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <table id="dataTable3" class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{-- <button data-toggle="modal" data-target="#edit" class="btn btn-warning">E</button> 
                                                        <button data-toggle="modal" data-target="#del" class="btn btn-danger">D</button> --}}
                                                        <a href="/editdataklr/{{ $item->id }}" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editklr{{ $item->id }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                        <a href="/hapusdataklr/{{ $item->id }}" onclick="return confirm('Apakah Anda Yakin ingin menghapus ?');"  class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                ...
                                                <!-- The Modal -->
                                                @foreach ($data1 as $item)
                                                <div class="modal fade" id="editklr{{ $item->id }}" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="/updatedataklr/{{ $item->id }}" method="POST">
                                                                @csrf
                                                                <!-- Modal Header -->
                                ...
                                <a href="/exportdatakeluar" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/datakeluar" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input name="penerima" type="text" class="form-control" placeholder="Penerima barang" autocomplete="off" required>
                        </div>
                        <div class="form-group">
